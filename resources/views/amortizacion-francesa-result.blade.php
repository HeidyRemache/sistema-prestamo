...
<body>
    ...
    @section('content')
        ...
        <button class="pdf bg-green-500 text-white px-4 py-2 rounded mt-4 inline-block" onclick="window.location.href='{{ url('/simulador/amortizacion-francesa/pdf') }}'">Descargar PDF</button>
        <div class="composicion mx-auto my-8">
            ...
            <div class="mb-4">
                <strong>Cuota:</strong> ${{ $composicionPrestamo['cuota'] }}
            </div>
            <div class="mb-4">
